...
class main:
  def install_tools(self):
    while True:
      ledxb1=ledxb1()
      num=1
      total=len(ledxb1.names)
      os.system("clear")
      logo.install_ledxb1()
      print("\007")
      for ledxb1_name in ledxb1.names:
        print (f" \033[01;32m[ \033[01;37m{num} \033[01;32m] \033[01;33minstall \033[01;32m{ledxb1_name}\033[00m")
        num+=1
      print("")
      logo.back()
      ...
      if cmd=="00" or cmd=="back":
        ...
        try:
          if int(cmd)>=1 and int(cmd)<=int(total):
            ...
            ledxb1.install(ledxb1.names[int(cmd)-1])
          else:
  ...
  def category(self):
    while True:
      ledxb1=ledxb1()
      total=len(ledxb1.category)
      num=1
      os.system("clear")
      logo.ledxb1_header()
      print("")
      for cat in ledxb1.category:
        print (f"  \033[01;32m[ \033[01;37m{num} \033[01;32m] \033[01;33m{ledxb1.category_data[cat]}\033[00m")
        num+=1
      print("")
      logo.back()
      cmd=input("\033[1;36m ##> \033[00m")
      if cmd=="00" or cmd=="back":
        ...
        try:
          if int(cmd) in range(1,int(total)+1):
            while True:
              print(int(cmd)-1)
              print(ledxb1.category[int(cmd)-1])
              cnt=1
              os.system("clear")
              logo.ledxb1_header()
              print("")
              tmp_cat_ledxb1=[]
              for i in ledxb1.names:
                if ledxb1.category[int(cmd)-1] in ledxb1.data[i]["category"]:
                  tmp_cat_ledxb1.append(ledxb1.data[i]['name'])
                  print(f" \033[01;32m[ \033[00m{cnt} \033[01;32m] \033[01;33minstall \033[01;32m{ledxb1.data[i]['name']}\033[00m")
                  cnt+=1
              print("")
              logo.back()
              ...
              if tcmd=="00" or tcmd=="back":
                ...
                try:
                  cat_total=len(tmp_cat_ledxb1)
                  if int(tcmd) in range(1,int(cat_total)+1):
                    os.system("clear")
                    logo.installing()
                    print("\033[01;32minstalling ....\033[00m")
                    ledxb1.install(tmp_cat_ledxb1[int(tcmd)-1])
                  else:
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/ledxb1"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/ledxb/ledxb1.git "+system.home+"/ledxb1")
            if os.path.exists(system.home+"/ledxb1/install.aex"):
              os.system("cd "+system.home+"/ledxb1 && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/ledxb1"):
              ...
              os.system("git clone https://github.com/ledxb/ledxb1.git "+system.home+"/ledxb1")
            if os.path.exists(system.home+"/ledxb1/install.aex"):
              os.system("cd "+system.home+"/ledxb1 && sh install.aex")
              if os.path.exists(system.bin+"/ledxb1") and os.path.exists(system.conf_dir+"/ledxb1"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall ledxb1" or cmd=="unistall ledxb1":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/ledxb1")
          os.system(system.sudo+" rm -rf "+system.bin+"/ledxb1")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/ledxb1")
        else:
          os.system("rm -rf "+system.bin+"/ledxb1")
          os.system("rm -rf "+system.bin+"/ledxb1")
          os.system("rm -rf "+system.conf_dir+"/ledxb1")
        os.system("clear")
        logo.exit()
        break
      else:
...
class ledxb1:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/ledxb1/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/ledxb1/core/cat.json") as cat_file:
